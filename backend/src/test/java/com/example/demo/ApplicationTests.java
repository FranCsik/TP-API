...
class ApplicationTests {
	...
	// 	try {
	// 		Edificio edificio = controlador.buscarEdificio(1);
	...
	// 		assert(controlador.reclamosPorEdificio(edificio).size() == 1);
	...
	// 		assert(controlador.reclamosPorEdificio(edificio).get(0).getImagenes().size() == 1);
	...
	// 		assert(controlador.reclamosPorEdificio(edificio).get(0).getEstado().equals(Estado.enProceso));
	// 	} catch (EdificioException | UnidadException | PersonaException | ReclamoException e) {
	// 		e.printStackTrace();
	// 	}
	// }
	...
	// 	try{
	// 		Persona persona = controlador.buscarPersona("DNI30868066");
	// 		Administrador administrador = controlador.agregarAdministrador(persona);
	// 		assert(administrador.getPersona().getDocumento().equals("DNI30868066"));
	// 		Administrador prueba = controlador.buscarAdministrador("DNI30868066");
	// 		assert(administrador.equals(prueba));
	// 	}catch(Exception e){
	...
	// 	try {
	// 		Edificio edificio = controlador.buscarEdificio(3);
	...
	// 		List<Reclamo> reclamos = controlador.reclamosPorEdificio(edificio);
	...
	// 		assert(controlador.reclamosPorEdificio(edificio).size() == 2);
